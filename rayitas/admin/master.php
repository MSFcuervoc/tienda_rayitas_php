    ...
    <main>
        ...
        <ul class="pagination justify-content-center ">
            <li class=" page-item previous <?php if($pag-1 < 0){?> disabled<?php }?>"> <a
                    href="master.php?pag=<?php echo $pag -1?>&total=<?php echo $total?>" class=" page-link">← Anterior</a>
            </li>
            ...
            <li class="page-item next <?php if($pag-1 > 0){?> disabled<?php }?>" style="float:right"> <a
                    href="master.php?pag=<?php echo $pag +1?>&total=<?php echo $total?>" class="page-link">Siguiente→</a></li>
